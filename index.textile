...
The basic interface mimics "marked":marked, the popular markdown parser. So if you use that in your project then you can support Textile as well with minimal effort.
